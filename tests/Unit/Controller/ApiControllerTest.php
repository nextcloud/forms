...
class ApiControllerTest extends TestCase {
	...
	public function testNewQuestion_conditionalQuestion() {
		...
		$response = $this->apiController->newQuestion($formId, Constants::ANSWER_TYPE_CONDITIONAL, 'Conditional Q');
	...
	public function testNewQuestion_subQuestion() {
		...
		$response = $this->apiController->newQuestion($formId, 'short', 'Sub Q', null, $parentQuestionId, $branchId);
		$this->assertInstanceOf(DataResponse::class, $response);
		$this->assertEquals(Http::STATUS_CREATED, $response->getStatus());
		$data = $response->getData();
	...
	public function testNewQuestion_nestedConditionalNotAllowed() {
		...
		$this->apiController->newQuestion($formId, Constants::ANSWER_TYPE_CONDITIONAL, 'Nested Conditional', null, $parentQuestionId, $branchId);
	}
	...
	public function testNewQuestion_parentNotFound() {
		...
		$this->apiController->newQuestion($formId, 'short', 'Sub Q', null, $parentQuestionId, $branchId);
	}
	...
	public function testNewQuestion_missingBranchId() {
		...
		$this->apiController->newQuestion($formId, 'short', 'Sub Q', null, $parentQuestionId, null);
	}
