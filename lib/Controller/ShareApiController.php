...
class ShareApiController extends OCSController {
	...
	#[CORS()]
	#[NoAdminRequired()]
	#[ApiRoute(verb: 'POST', url: '/api/{apiVersion}/forms/{formId}/shares', requirements: [
		'apiVersion' => 'v3',
		'formId' => '\d+',
		'questionId' => '\d+',
		'optionId' => '\d+',
	...
	#[CORS()]
	#[NoAdminRequired()]
	#[ApiRoute(verb: 'PATCH', url: '/api/{apiVersion}/forms/{formId}/shares/{shareId}', requirements: [
		'apiVersion' => 'v3',
		'formId' => '\d+',
		'questionId' => '\d+',
		'optionId' => '\d+',
	...
	#[CORS()]
	#[NoAdminRequired()]
	#[ApiRoute(verb: 'DELETE', url: '/api/{apiVersion}/forms/{formId}/shares/{shareId}', requirements: [
		'apiVersion' => 'v3',
		'formId' => '\d+',
		'questionId' => '\d+',
		'optionId' => '\d+',
