...
<template>
	<div class="wrapper group-master table-row table-header" v-if="header">
	...
	<div class="wrapper table-row table-body group-master" v-else>
		<div class="wrapper group-1">
			<div>
				<img class="icontwo">
			</div>
		...
		<div class="wrapper group-2">
			...
			<div class="wrapper group-2-9">
				<a @click="copyLink" class="icon icon-clippy svg delete-form"/>
				<span class="hidden-visually">
					{{ t('forms', 'Copy link') }}
				</span>
			</div>
			<div class="list-results wrapper">
				<a @click="viewResults"
				   class="icon icon-toggle svg delete-form"/>
				<span class="hidden-visually">
					{{ t('forms', 'View results') }}
				</span>
			</div>
			...
			<div class="wrapper group-2-1">
				<div :class="form.event.access" class="thumbnail access"
					 v-tooltip="accessType">
					{{ accessType }}
				</div>
			</div>
			<div class="owner">
				<user-div :display-name="form.event.ownerDisplayName"
			...
			<div class="wrapper group-2-2">
				...
				<div :class="{ expired : form.event.expired }" class="expiry">
					{{ timeSpanExpiration }}
				</div>
			</div>
		</div>
