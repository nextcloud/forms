	...
	<NcAppContent :page-heading="t('forms', 'Results')">
		...
		<header>
			...
			<div class="response-actions">
				<PillMenu
					:disabled="noSubmissions && submissionSearch.length === 0"
		...
		<NcEmptyContent
			v-else-if="noSubmissions && submissionSearch.length > 0"
...
import { debouncedProperty } from '../utils/debounce.js'
...
export default {
	...
	computed: {
		submissionSearch: debouncedProperty(''),
