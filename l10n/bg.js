OC.L10N.register(
    ...
    "Responses are connected to your Nextcloud account." : "Отговорите са свързани с вашия Nextcloud профил.",
    ...
    "Share via link" : "Споделене чрез връзка",
    "Show to all users of this instance" : "Показване на този екземпляр на всички потребители",
    "Choose users to share with" : "Избор на потребители, с които да споделите ",
    "Settings" : "Настройки",
    "Anonymous responses" : "Анонимни отговори",
    ...
    "Select expiration date" : "Избор на срок на валидност",
    ...
    "Multiple choice question title" : "Заглавие на въпрос с множествен избор",
    ...
    "Enter a short answer" : "Въвеждане на кратък отговор",
