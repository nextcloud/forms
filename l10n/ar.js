OC.L10N.register(
    ...
    "Permit access to all logged in accounts" : "حق الوصول لكل الحسابات الداخلة",
    ...
    "You're going to transfer the ownership of {name} to another account. Please select the account to which you want to transfer ownership." : "أنت في طريقك لنقل ملكية حساب {name} إلى حساب آخر. من فضلك، حدِّد الحساب الذي ترغب في نقل ملكيته.",
    ...
    "Create XLSX" : "أنشِيءْ ملف XLSX",
    "Create CSV" : "أنشِيءْ ملف CSV",
    "Create ODS" : "أنشِيءْ ملف ODS",
