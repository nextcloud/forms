OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with circle {circle}" : "{user} شارك النموذج {formTitle} مع الدائرة {circle}",
    ...
    "Search for user, group or circle …" : "البحث عن مستخدِم أو مجموعة أو دائرة ...",
