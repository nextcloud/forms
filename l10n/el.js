OC.L10N.register(
    ...
    {
    "Forms" : "Φόρμες",
    "{user} has shared the form {formTitle} with you" : "{χρήστης} έχει διαμοιραστεί την φόρμα {Τίτλοςφόρμας} με εσάς",
    "{user} has shared the form {formTitle} with group {group}" : "{χρήστης} έχει διαμοιραστεί την φόρμα {Τίτλοςφόρμας} με την ομάδα {ομάδα}",
    "{user} answered your form {formTitle}" : "{χρήστης} απάντησε στην φόρμα σας {Τίτλοςφόρμας}",
    ...
    "Responses are connected to your Nextcloud account." : "Οι απαντήσεις συνδέονται στον λογαριασμό σας στο Nextcloud.",
    ...
    "There was an error, while exporting to Files" : "Υπήρξε σφάλμα κατά την εξαγωγή στο Files",
    ...
    "Datetime question title" : "Τίτλος ερώτησης ημερομηνιας και ώρας",
