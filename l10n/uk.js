OC.L10N.register(
    ...
    "Error changing archived state of form" : "Помилка зміни статусу архівації форми",
    ...
    "Archived forms do not accept new submissions and can not be modified." : "Архівована форма не приймає нові відповіді і її не можна змінювати.",
    "Custom submission message" : "Текст після відправлення форми",
    "Message to show after a user submitted the form (formatting using Markdown is supported)" : "Повідомлення, що показується після відправлення користувачем форми (підтримується форматування Markdown)",
    "Message to show after a user submitted the form. Please note that the message will not be translated!" : "Повідомлення, що показується після відправлення користувачем форми. Зверніть увагу, повідомлення задається тільки однією мовою.",
    ...
    "Search for user, group or team …" : "Пошук користувачів, груп, команд...",
    "Permissions" : "Дозволи ",
    "View responses" : "Перегляд відповідей",
    "Delete responses" : "Вилучити відповіді",
    "Group" : "Група",
    "Team" : "Команда",
    ...
    "Form is archived" : "Форма заархівована",
    "Form '{title}' is archived and cannot be modified." : "Форма '{title}' заархівована через це її не можна редагувати.",
