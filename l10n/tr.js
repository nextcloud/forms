OC.L10N.register(
    ...
    "Only works for logged in users who can access this form" : "Yalnızca bu forma erişebilen oturum açmış kullanıcılar için geçerlidir",
    "Copy to clipboard" : "Panoya kopyala",
    "Public share link" : "Herkese açık paylaşım bağlantısı",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as public link. We recommend replacing the link with a new public link." : "Eski paylaşım ile uyumlu olmak için iç bağlantı hala herkese açık bir bağlantı olarak kullanılabilir. Bu bağlantıyı yeni bir herkese açık bağlantı ile değiştirmenizi öneririz.",
    ...
    "People can pick a date" : "Kişi bir tarih seçebilir",
