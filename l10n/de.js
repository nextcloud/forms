OC.L10N.register(
    ...
    "Title of question number {index}" : "Titel der Frage Nummer {index}",
    ...
    "People can enter a long answer" : "Nutzer können einen langen Text eingeben",
    "Add a new answer" : "Neue Antwort hinzufügen",
    "A short answer for the question “{text}”" : "Eine kurze Antwort zu Frage „{text}“",
    "People can enter a short answer" : "Nutzer können einen kurzen Text eingeben",
    "Group" : "Gruppe",
    ...
    "Submit" : "Übermitteln",
    "Submit form" : "Formular speichern",
    "Submitting form …" : "Speichere Formular ...",
    "Thank you for completing the form!" : "Vielen Dank für deine Teilnahme!",
    "There was an error submitting the form" : "Beim Speichern des Formulars ist ein Fehler aufgetreten",
    "Multiple choice" : "Mehrfachauswahl",
    "Checkboxes" : "Kontrollkästchen",
    "Short answer" : "Kurze Antwort",
    "Long text" : "Langer Text",
    "Form Expired" : "Formular abgelaufen",
    "This Form has expired and is no longer taking answers" : "Dieses Formular ist abgelaufen und kann nicht mehr beantwortet werden",
