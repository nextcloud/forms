OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with circle {circle}" : "{user} nasdílel(a) formulář {formTitle} okruhu {circle}",
    ...
    "Search for user, group or circle …" : "Hledat uživatele, skupinu nebo okruh…",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. We recommend replacing the link with a new Share link." : "Kvůli kompatibilitě se sdílením dle starého způsobu, vnitřní odkaz je pořád ještě použitelný jako ten pro sdílení. Ovšem doporučujeme nahradit odkaz novým odkazem pro sdílení.",
    ...
    "Save as {filename}" : "Uložit jako {filename}",
    "Save to home" : "Uložit do domovské složky",
    "Save to {path}" : "Uložit do {path}",
    "No target selected" : "Nevybrán žádný cíl",
