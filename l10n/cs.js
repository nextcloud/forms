OC.L10N.register(
    ...
    {
    "Forms" : "Formuláře",
    "{user} has shared the form {formTitle} with you" : "{user} s vámi sdílel(a) formulář {formTitle}",
    "{user} has shared the form {formTitle} with group {group}" : "{user} sdílel(a) formulář {formTitle} se skupinou {group}",
    "{user} answered your form {formTitle}" : "{user} odpověděl(a) na váš formulář {formTitle}",
    "Anonymous user" : "Anonymní uživatel",
    "A form has been <strong>shared</strong> with you" : "Byl vám <strong>sdílen</strong> formulář",
