OC.L10N.register(
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. Please replace the link with a new Share link. The internal sharing link will not work anymore starting with Forms 5.0" : "Por compatibilidad con la compartición antigua, el enlace interno todavía se puede usar como enlace para compartir. Recomendamos reemplazar el enlace por un nuevo enlace de compartición. El enlace de compartición interno dejará de funcionar a partir de la versión 5.0 de Forms.",
    "Remove Legacy Link" : "Eliminar enlace antiguo",
    "Legacy link in use" : "Enlace antiguo en uso",
    "This form still uses a deprecated share link, that will be removed in Forms 5.0. Please use the new sharing mechanism." : "Este formulario todavía utiliza un enlace de compartición legado, que será eliminado en Forms 5.0. Por favor, utilice el nuevo mecanismo de compartición"
},
