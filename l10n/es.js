OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with circle {circle}" : "{user} ha compartido el formulario {formTitle} con el círculo {circle}",
    ...
    "Search for user, group or circle …" : "Buscar usuario, grupo o círculo …",
    ...
    "Save as {filename}" : "Guardar como {filename}",
    "Save to home" : "Guardar a la carpeta de inicio",
    "Save to {path}" : "Guardar a {path}",
    "No target selected" : "No se seleccionó un destino",
