OC.L10N.register(
    ...
    "{user} answered your form {formTitle}" : "{user} ha respondido a tu formulario \"{formTitle}\"",
    ...
    "**Simple surveys and questionnaires, self-hosted!**\n\n- **📝 Simple design:** No mass of options, only the essentials. Works well on mobile of course.\n- **📊 View & export results:** Results are visualized and can also be exported as CSV in the same format used by Google Forms.\n- **🔒 Data under your control!** Unlike in Google Forms, Typeform, Doodle and others, the survey info and responses are kept private on your instance.\n- **🧑‍💻 Connect to your software:** Easily integrate Forms into your service with our full-fledged [REST-API](https://github.com/nextcloud/forms/blob/main/docs/API.md).\n- **🙋 Get involved!** We have lots of stuff planned like more question types, collaboration on forms, [and much more](https://github.com/nextcloud/forms/milestones)!" : "**¡Encuestas y cuestionarios sencillos, autohospedados!**\n      \n      - **📝 Diseño sencillo:** Sin un montón de opciones, solo lo esencial. Funciona bien en dispositivos móviles, por supuesto.\n      - **📊 Ver y exportar resultados:** Los resultados se visualizan y también se pueden exportar como CSV en el mismo formato utilizado por Google Forms.\n      - **🔒 Tus datos bajo tu control:** A diferencia de Google Forms, Typeform, Doodle y otros, la información y las respuestas de la encuesta se mantienen privadas en tu instancia.\n      - **🧑‍💻 Conéctalo a tu software:** Integra fácilmente Formularios en tu servicio con nuestra completa [API REST](https://github.com/nextcloud/forms/blob/main/docs/API.md).\n      - **🙋 ¡Participa!** Tenemos muchas cosas planeadas, como más tipos de preguntas, colaboración en formularios y [mucho más](https://github.com/nextcloud/forms/milestones)!",
    ...
    "Drag to reorder the questions" : "Arrastra para reordenar las preguntas",
    ...
    "Search for user or group …" : "Buscar usuario o grupo...",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. We recommend replacing the link with a new Share link." : "Por compatibilidad con la antigua compartición, el enlace interno todavía es utilizable como enlace de compartición. Recomendamos reemplazar el enlace con un nuevo enlace de compartición.",
