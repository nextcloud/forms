OC.L10N.register(
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. Please replace the link with a new Share link. The internal sharing link will not work anymore starting with Forms 5.0" : "為了與舊版的分享連結相容，內部連結仍可用作分享連結。請以新的分享連結取代舊的。從 Forms 5.0 開始，內部分享連結將無法運作",
    "Remove Legacy Link" : "移除舊版連結",
    "Legacy link in use" : "正在使用舊版連結",
    "This form still uses a deprecated share link, that will be removed in Forms 5.0. Please use the new sharing mechanism." : "此表單仍在使用棄用的分享連結，這將會在 Forms 5.0 中移除。請使用新的分享機制。"
},
"nplurals=1; plural=0;");
