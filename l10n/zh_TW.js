OC.L10N.register(
    ...
    "Show to all users of this instance" : "對此站台所有的使用者開放表單",
    "Choose users to share with" : "選擇要分享的使用者",
    "Settings" : "設定",
    "Anonymous responses" : "匿名回應",
    "Allow multiple responses per person" : "允許單人送出多次作答回應",
    "Set expiration date" : "設定到期日",
    "Expiration date" : "到期日",
    "Select expiration date" : "選取到期日期",
    ...
    "Multiple choice question title" : "多項目單選題標題",
    "Dropdown" : "下拉式選單",
