OC.L10N.register(
    ...
    "Group" : "群組",
    "Internal link" : "內部連結",
    "Only works for logged in users who can access this form" : "僅適用於可存取此表單的已登入使用者",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as public link. We recommend replacing the link with a new public link." : "為了與舊的分享連結相容，內部連結仍然可用做公開連結。我們建議使用新的公開連結取代舊連結。",
