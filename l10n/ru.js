OC.L10N.register(
    ...
    {
    "Forms" : "Опросы",
    "{user} has shared the form {formTitle} with you" : "{user} поделился опросом {formTitle} с Вами",
    "{user} has shared the form {formTitle} with group {group}" : "{user} поделился опросом {formTitle} с группой {group}",
    "{user} answered your form {formTitle}" : "{user} прошел Ваш опрос {formTitle}",
    ...
    "Someone <strong>answered</strong> a form" : "Кто то <strong>прошел</strong> опрос",
    "Copy" : "Копировать",
    ...
    "New form" : "Новый опрос",
    "Your Forms" : "Ваши опросы",
    "Shared with you" : "Поделился с Вами",
    "Loading forms …" : "Загрузка опроса ...",
    "No forms created yet" : "Нет созданных опросов",
    "Create a form" : "Создать опрос",
    "Select a form or create a new one" : "Выберите опрос или создайте новый",
    "Create new form" : "Создать новый опрос",
    "An error occurred while loading the forms list" : "Произошла ошибка при загрузке списка опросов",
    "Unable to create a new form" : "Невозможно создать новый опрос",
    "Unable to copy form" : "Невозможно скопировать опрос",
    "Results" : "Результаты",
    "Copy form" : "Скопировать опрос",
    "Delete form" : "Удалить опрос",
    "Form link copied" : "Ссылка на опрос скопирована",
    ...
    "Form title" : "Название опроса",
    "Description" : "Описание",
    "Add a question" : "Добавить вопрос",
    "Responses are anonymous." : "Ответы анонимны.",
    "Responses are connected to your Nextcloud account." : "Ответы связаны с вашей учетной записью Nextcloud. ",
    ...
    "Error while saving form" : "Ошибка при сохранении опроса",
    ...
    "Export successful to {file}" : "Экспортировано успешно в файл {file}",
    ...
    "Share form" : "Поделиться опросом",
    "Share via link" : "Поделиться при помощи ссылки",
    "Show to all users of this instance" : "Показать всем пользователям NextCloud (Ваш сервер)",
    ...
    "Submitting form …" : "Сохранение опроса...",
    "Thank you for completing the form!" : "Спасибо за заполнение опроса!",
    "Submit" : "Отправить ответ",
    "Submit form" : "Сохранить опрос",
    "There was an error submitting the form" : "При отправке опроса произошла ошибка",
    ...
    "Multiple choice question title" : "Введите вопрос",
    "Dropdown" : "Раскрываемый список",
    "Dropdown question title" : "Введите вопрос",
    "People can pick one option" : "Люди смогут выбрать один вариант",
    ...
    "Enter a short answer" : "Введите ответ",
    "Long text" : "Длинный ответ",
    "Long text question title" : "Введите вопрос",
    "People can enter a long text" : "Люди могут написать длинный ответ",
    "Enter a long text" : "Введите ответ (может быть большой длины)",
    "Date" : "Дата",
    "Date question title" : "Укажите заголовок",
    "People can pick a date" : "Люди смогут выбрать дату",
    "Pick a date" : "Выберите дату",
    "Datetime" : "Дата и время",
    "Datetime question title" : "Укажите заголовок",
    "People can pick a date and time" : "Люди могут выбрать дату и время",
    "Pick a date and time" : "Выберите время и дату",
    "Form expired" : "Опрос завершён",
    "This form has expired and is no longer taking answers" : "Срок действия этого опроса истек и ответы больше не принимаются.",
    "Form not found" : "Опрос не найден",
    "This form does not exist" : "Этот опрос не существует"
},
