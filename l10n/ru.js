OC.L10N.register(
    ...
    "Archive form" : "Архивировать форма",
    "Are you sure you want to delete {title}?" : "Подтвердите удаление {title}.",
    "Cancel" : "Отмена",
    "Add options" : "Добавить параметры",
    "Options should be separated by new line!" : "Параметры должны быть разделены новой строкой!",
    "Add multiple options" : "Добавить несколько вариантов",
    "Add multiple options (one per line)" : "Добавьте несколько вариантов (по одному в строке)",
    "Options" : "Варианты",
    ...
    "Add a new answer option" : "Добавьте новый вариант ответа",
    ...
    "Move option up" : "Переместить параметр вверх",
    "Move option down" : "Переместить параметр вниз",
    ...
    "Delete" : "Удалить",
    "Uploading …" : "Передача…",
    "Add new file as answer" : "Добавьте новый файл в качестве ответа",
    ...
    "Require a minimum of options to be checked" : "Требуйте проверки минимального количества вариантов",
    "Minimum options to be checked" : "Минимальные параметры для проверки",
    "Require a maximum of options to be checked" : "Требовать проверки максимального количества вариантов",
    "Maximum options to be checked" : "Максимальное количество вариантов для проверки",
    "Other:" : "Другое:",
    "Other" : "Другое",
