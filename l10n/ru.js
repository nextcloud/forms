OC.L10N.register(
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. Please replace the link with a new Share link. The internal sharing link will not work anymore starting with Forms 5.0" : "Для обеспечения совместимости со старым общим доступом внутренняя ссылка по-прежнему используется в качестве ссылки для общего доступа. Пожалуйста, замените ее новой ссылкой для общего доступа. Начиная с версии Forms 5.0 внутренняя ссылка для общего доступа больше не будет работать",
    "Remove Legacy Link" : "Удалить устаревшую ссылку",
    "Legacy link in use" : "Используется устаревшая ссылка",
    "This form still uses a deprecated share link, that will be removed in Forms 5.0. Please use the new sharing mechanism." : "В этой форме по-прежнему используется устаревшая ссылка на общий доступ, которая будет удалена в версии Forms 5.0. Пожалуйста, используйте новый механизм общего доступа."
},
