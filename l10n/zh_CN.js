OC.L10N.register(
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. Please replace the link with a new Share link. The internal sharing link will not work anymore starting with Forms 5.0" : "为兼容旧版共享功能，内部链接仍可用作分享链接。我们建议将这类链接替换为新的分享链接。从 Forms 5.0 开始，内部分享链接将不再可用。",
    "Remove Legacy Link" : "移除旧版链接",
    "Legacy link in use" : "正在使用旧版链接",
    "This form still uses a deprecated share link, that will be removed in Forms 5.0. Please use the new sharing mechanism." : "此表单仍在使用过时的分享链接，此链接将在 Forms 5.0 中被移除。请使用新的分享机制。"
},
"nplurals=1; plural=0;");
