OC.L10N.register(
    ...
    "Delete results" : "刪除結果",
    "Embed" : "嵌入",
    "Embed the form in external websites" : "將表格嵌入外部網站",
    ...
    "You must answer this question" : "你必須回答此問題",
    ...
    "_Choose exactly one option_::_Choose exactly %n options_" : ["請剛好選擇 %n 個選項"],
    "Choose between {min} and {max} options" : "請選擇 {min} 至 {max} 個選項",
    "_Choose at least one option_::_Choose at least %n options_" : ["請選擇至少 %n 個選項"],
    "_Choose at most one option_::_Choose at most %n options_" : ["請選擇最多 %n 個選項"],
    "Upper options limit must not exceed the number of available options" : "選項上限不可超過可用選項數目",
    "Upper options limit must be greater than the lower limit" : "選項上限必須大於下限",
    "Lower options limit must be smaller than the number of available options" : "選項下限必須少於可用選項數目",
    ...
    "Other:" : "其它：",
    "Other" : "其它",
    "You must rank all options" : "你必須為所有選項排序",
    "All options ranked" : "所有選項已排序",
    "Your ranking" : "你的排序",
    "Remove from ranking" : "從排序中移除",
    "Tap options above to rank them" : "點擊上方選項以進行排序",
    ...
    "No response" : "無回應",
    "Ranked by Borda count: each 1st place receives {n} points, 2nd place {n1} points, and so on. Higher score means more preferred." : "採用 Borda 計分法排序：第 1 名獲得 {n} 分，第 2 名獲得 {n1} 分，如此類推。分數越高代表越受偏好。",
    ...
    "Form will be closed automatically when the limit is reached." : "達到上限後，表單將會自動關閉。",
    "Close form" : "關閉表格",
    ...
    "Embeddable link token" : "可嵌入的連結權杖",
    "Share link token" : "分享連結權杖",
    "Set the public share link token to something easy to remember or generate a new token." : "將公開分享連結權杖設定為容易記住的內容，或產生新的權杖。",
    "Generating…" : "正在產生 …",
    ...
    "Pick a color" : "挑選顏色",
    "Ranking" : "排序",
    "Ranking question title" : "排序問題標題",
    "People can rank options" : "使用者可為選項排序",
    "Drag to rank" : "拖曳以排序",
    "Image" : "圖像",
    "Document" : "文件",
    "Presentation" : "簡報",
