OC.L10N.register(
    ...
    "Group" : "群組",
    "Internal link" : "內部連結",
    "Only works for logged in users who can access this form" : "僅適用於可以存取此表格的登錄用戶",
    "Copy to clipboard" : "複製到剪貼板",
    "Public share link" : "公共分享連結",
    "Add public link" : "新增一個公開連結",
    "Public Share Link" : "公共分享連結",
    "Remove link" : "移除連結",
    "Legacy Link" : "舊版連結",
    "Form still supports old sharing-link." : "表格仍然支持舊的分享連結。",
    "For compatibility with the old Sharing, the internal link is still usable as public link. We recommend replacing the link with a new public link." : "為了兼容舊的分享連結，內部連結仍然可以用作公共連結。我們建議將連結替換為新的公共連結。",
    "Remove Legacy Link" : "移除舊版連結",
    "Permit access to all logged in users" : "允許存取所有登錄用戶",
    "Show to all users on sidebar" : "在側邊欄上顯示給所有用戶",
