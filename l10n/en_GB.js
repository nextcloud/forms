OC.L10N.register(
    ...
    "Thank you for submitting the form \"%s\"." : "Thank you for submitting the form \"%s\".",
    "responses" : "responses",
    ...
    "Embed" : "Embed",
    "Embed the form in external websites" : "Embed the form in external websites",
    ...
    "Allow form owners to send a confirmation email to respondents after submission." : "Allow form owners to send a confirmation email to respondents after submission.",
    "Allow confirmation emails to form respondents" : "Allow confirmation emails to form respondents",
    "Mail server is not configured. Please configure it in the basic settings before enabling this feature." : "Mail server is not configured. Please configure it in the basic settings before enabling this feature.",
    "Rate limit (emails per recipient per 24 hours)" : "Rate limit (emails per recipient per 24 hours)",
    "Maximum number of confirmation emails sent to the same address per 24 hours." : "Maximum number of confirmation emails sent to the same address per 24 hours.",
    "Form sharing" : "Form sharing",
    "Allow sharing by link" : "Allow sharing by link",
    "Allow custom public share tokens" : "Allow custom public share tokens",
    ...
    "The text of column {index}" : "The text of column {index}",
    "The text of row {index}" : "The text of row {index}",
    "The text of option {index}" : "The text of option {index}",
    "Column number {index}" : "Column number {index}",
    "Row number {index}" : "Row number {index}",
    ...
    "_Choose exactly one option_::_Choose exactly %n options_" : ["Choose exactly one option","Choose exactly %n options"],
    "Choose between {min} and {max} options" : "Choose between {min} and {max} options",
    "_Choose at least one option_::_Choose at least %n options_" : ["Choose at least one option","Choose at least %n options"],
    "_Choose at most one option_::_Choose at most %n options_" : ["Choose at most one option","Choose at most %n options"],
    "Upper options limit must not exceed the number of available options" : "Upper options limit must not exceed the number of available options",
    "Upper options limit must be greater than the lower limit" : "Upper options limit must be greater than the lower limit",
    "Lower options limit must be smaller than the number of available options" : "Lower options limit must be smaller than the number of available options",
    ...
    "Other:" : "Other:",
    "Other" : "Other",
    "You must rank all options" : "You must rank all options",
    "All options ranked" : "All options ranked",
    "Your ranking" : "Your ranking",
    "Remove from ranking" : "Remove from ranking",
    "Tap options above to rank them" : "Tap options above to rank them",
    ...
    "Ranked by Borda count: each 1st place receives {n} points, 2nd place {n1} points, and so on. Higher score means more preferred." : "Ranked by Borda count: each 1st place receives {n} points, 2nd place {n1} points, and so on. Higher score means more preferred.",
    ...
    "Add at least one email field before confirmation emails can be used." : "Add at least one email field before confirmation emails can be used.",
    "Select which email field should receive confirmation emails before finishing this setup." : "Select which email field should receive confirmation emails before finishing this setup.",
    ...
    "Limit number of responses" : "Limit number of responses",
    "Maximum number of responses" : "Maximum number of responses",
    "Form will be closed automatically when the limit is reached." : "Form will be closed automatically when the limit is reached.",
    ...
    "Send confirmation email to respondents" : "Send confirmation email to respondents",
    "Recipient field" : "Recipient field",
    "Select an email field" : "Select an email field",
    "Available placeholders:" : "Available placeholders:",
    "and field labels." : "and field labels.",
    "Thank you for your {formTitle} submission" : "Thank you for your {formTitle} submission",
    ...
    "There was an error while updating the link token" : "There was an error while updating the link token",
    "There was an error while generating the link token" : "There was an error while generating the link token",
    "Share link" : "Share link",
    "Add link" : "Add link",
    "Embeddable link" : "Embeddable link",
    "Embeddable link token" : "Embeddable link token",
    "Share link token" : "Share link token",
    "Set the public share link token to something easy to remember or generate a new token." : "Set the public share link token to something easy to remember or generate a new token.",
    ...
    "This form has reached the maximum number of responses" : "This form has reached the maximum number of responses",
    ...
    "Grid question title" : "Grid question title",
    "People can submit a grid answer" : "People can submit a grid answer",
    ...
    "Ranking" : "Ranking",
    "Ranking question title" : "Ranking question title",
    "People can rank options" : "People can rank options",
    "Drag to rank" : "Drag to rank",
    "Image" : "Image",
    "Document" : "Document",
