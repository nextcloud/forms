OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with circle {circle}" : "{user} has shared the form {formTitle} with circle {circle}",
    ...
    "Search for user, group or circle …" : "Search for user, group or circle …",
    ...
    "Responses" : "Responses",
    "Options" : "Options",
    "Save CSV to Files" : "Save CSV to Files",
