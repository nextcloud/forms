OC.L10N.register(
    ...
    "Forms navigation" : "Formulaires navigation",
    "New form" : "Nouveau formulaire",
    "Your forms" : "Vos formulaires",
    "Shared with you" : "Partagés avec vous",
    "Archived forms" : "Formulaires achevés",
    ...
    "There was an error during submitting the file: {message}." : "Erreur au téléchargement du fichier : {message}.",
    "Allow only specific file types" : "Permettre seulement certains types de fichier",
    "Custom file extensions" : "Extensions de fichier personnalisée",
    ...
    "Require a minimum of options to be checked" : "Demander qu'un nombre minimum d'options soient cochées",
    "Minimum options to be checked" : "Nombre minimum d'options cochées",
    "Require a maximum of options to be checked" : "Ne pas dépasser un certain nombre d'options cochées",
    ...
    "Convert to embeddable link" : "Convertir en un lien intégrable",
    ...
    "You're going to transfer the ownership of {name} to another account. Please select the account to which you want to transfer ownership." : "Vous allez transférer les droits de propriété de {name} à un autre compte. Veuillez sélectionner le compte vers lequel vous souhaitez effectuer ce transfert.",
    ...
    "Form '{title}' is locked by {lockedBy} and cannot be modified. The lock expires: {lockedUntil}" : "Le formulaire '{title}' es verrouillé par {lockedBy} et ne peut pas être modifié. Le verrouillage expire dans : {lockedUntil}",
    ...
    "There was an error while linking the file" : "Une erreur s'est produite lors de la liaison du fichier",
    "Export successful to {file}" : "Export réussi vers {file}",
    "There was an error while exporting to Files" : "Il y a eu une erreur lors de l'export vers Fichiers",
    ...
    "Error while saving question options" : "Erreur lors de l'enregistrement des questions en options",
    "There was an issue deleting this option" : "Un problème est survenu en supprimant cette option",
    "Error while saving options order" : "Erreur lors de l'enregistrement des options",
    ...
    "Number" : "Nombre",
    "The input is not a valid number" : "La saisie n'est pas un numéro valide",
