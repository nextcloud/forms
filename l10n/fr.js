OC.L10N.register(
    ...
    "Only works for logged in users who can access this form" : "Fonctionne seulement pour les utilisateurs enregistrés qui ont accès à ce formulaire",
    "Copy to clipboard" : "Copier dans le presse-papiers",
    "Public share link" : "Lien de partage public",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as public link. We recommend replacing the link with a new public link." : "Pour la compatibilité avec les anciens liens, le lien interne reste utilisable comme lien public. Nous recommandons de remplacer le lien avec un nouveau lien public",
    "Remove Legacy Link" : "Supprimer le lien originel",
    "Permit access to all logged in users" : "Permettre l'accès à tous les utilisateurs enregistrés",
    "Show to all users on sidebar" : "Montrer à tous les utilisateurs dans la barre latérale",
    "There was an error while adding the share" : "Une erreur s'est produite lors de l'ajout d'un partage",
    "There was an error while adding the link." : "Une erreur s'est produite lors de l'ajout d'un lien.",
