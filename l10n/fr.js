OC.L10N.register(
    ...
    "**Simple surveys and questionnaires, self-hosted!**\n\n- **📝 Simple design:** No mass of options, only the essentials. Works well on mobile of course.\n- **📊 View & export results:** Results are visualized and can also be exported as CSV in the same format used by Google Forms.\n- **🔒 Data under your control!** Unlike in Google Forms, Typeform, Doodle and others, the survey info and responses are kept private on your instance.\n- **🙋 Get involved!** We have lots of stuff planned like more question types, collaboration on forms, [and much more](https://github.com/nextcloud/forms/milestones)!" : "**Simples enquêtes et questionnaires , auto-hébergés !**\n\n- **📝 Design simple:** Pas de d'excès d'options, seulement l'essentiel. Fonctionne bien sûr bien sur mobile.\n- **📊 Visualisation et exportation des résultats :** Les résultats sont visualisables et peuvent aussi être exportés en CSV dans le même format que celui utilisé par Google Forms.\n- **🔒 Les données sous votre contrôle !** Contrairement à Google Forms, Typeform, Doodle et autres, les infos et réponses de l'enquête restent privées sur votre instance.\n- **🙋 Contribuez !** Nous avons beaucoup de choses prévues comme plus de types de questions, l'édition collaborative, [et bien plus encore](https://github.com/nextcloud/forms/milestones) !",
    ...
    "Expires {relativeDate}." : "Expire dans {relativeDate}.",
