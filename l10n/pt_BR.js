OC.L10N.register(
    ...
    "Form is locked" : "O formulário está bloqueado",
    "Lock by {lockedBy}, expires: {lockedUntil}" : "Bloqueio por {lockedBy}, expira: {lockedUntil}",
    "never" : "nunca",
    "Open lock" : "Bloqueio aberto",
    "Unlock form" : "Formulário de desbloqueio",
    ...
    "Lock form permanently" : "Bloquear formulário permanentemente",
    ...
    "Type {text} to confirm." : "Digite {texto} para confirmar.",
    ...
    "Form '{title}' is locked by {lockedBy} and cannot be modified. The lock expires: {lockedUntil}" : "Formulario '{title}' está bloqueado por {lockedBy} e não pode ser modificado. O bçoqueio termina em: {lockedUntil}",
