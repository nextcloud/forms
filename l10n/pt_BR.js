OC.L10N.register(
    ...
    "never" : "nunca",
    "Unlock form" : "Desbloquear formulário",
    ...
    "Form '{title}' is locked by {lockedBy} and cannot be modified. The lock expires: {lockedUntil}" : "Formulário '{title}' está bloqueado por {lockedBy} e não pode ser modificado. O bloqueio termina em: {lockedUntil}",
