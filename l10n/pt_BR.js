OC.L10N.register(
    ...
    "Only works for logged in users who can access this form" : "Funciona apenas para usuários logados que podem acessar este formulário",
    "Copy to clipboard" : "Copiar para área de transferência",
    "Public share link" : "Link de compartilhamento público",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as public link. We recommend replacing the link with a new public link." : "Para compatibilidade com o antigo Compartilhamento, o link interno ainda pode ser usado como link público. Recomendamos substituir o link por um novo link público.",
    "Remove Legacy Link" : "Remover Link Legado",
    "Permit access to all logged in users" : "Permitir acesso a todos os usuários conectados",
    "Show to all users on sidebar" : "Mostrar para todos os usuários na barra lateral",
