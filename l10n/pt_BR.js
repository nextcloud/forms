OC.L10N.register(
    ...
    "Someone <strong>answered</strong> a shared form" : "Alguem <strong>respodeu</strong> um formulário compartilhado",
    "Someone <strong>answered</strong> a form" : "Alguém <strong>respondeu</strong> ao formulário",
    "Nextcloud Forms" : "Formulários Nextcloud",
    ...
    "Error changing archived state of form" : "Erro ao alterar o estado arquivado do formulário",
    ...
    "Archive form" : "Formulário de arquivo",
    ...
    "Delete" : "Excluir",
    "Uploading …" : "Enviando...",
    "Add new file as answer" : "Adicione novo arquivo como resposta",
    ...
    "Add \"other\"" : "Adicione \"outro\"",
    "Require a minimum of options to be checked" : "Exigir um mínimo de opções a serem verificadas",
    "Minimum options to be checked" : "Opções mínimas a serem verificadas",
    "Require a maximum of options to be checked" : "Exigir que um máximo de opções sejam verificadas",
    "Maximum options to be checked" : "Máximo de opções a serem verificadas",
    "Other:" : "Outro:",
    "Other" : "Outro",
    ...
    "This can not be controlled, if the form has a public link or stores responses anonymously." : "Isso não pode ser controlado, se o formulário tiver um link público ou armazenar respostas anonimamente.",
    ...
    "Search for user, group or team …" : "Procure por usuário, grupo ou equipe…",
    "Group" : "Grupo",
    "Team" : "Equipe",
    ...
    "You're going to transfer the ownership of {name} to another account. Please select the account to which you want to transfer ownership." : "Você transferirá a propriedade de {name} para outra conta. Selecione a conta para a qual deseja transferir a propriedade.",
    "Search for a user" : "Procure um usuário",
    ...
    "I understand, transfer this form" : "Isto não pode ser desfeito.",
    ...
    "Expired {relativeDate}." : "{relativeDate} expirado.",
    "Expires {relativeDate}." : "Expira em {relativeDate}.",
    ...
    "Choose spreadsheet location" : "Escolha o local da planilha",
    "Create XLSX" : "Criar XLSX",
    "Create CSV" : "Criar CSV",
    "Create ODS" : "Criar ODS",
    "Select {file}" : "Selecione o {file}",
    ...
    "File" : "Arquivo",
    "File question title" : "Título da pergunta do arquivo",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. Please replace the link with a new Share link. The internal sharing link will not work anymore starting with Forms 5.0" : "Para compatibilidade com o antigo compartilhamento, o link interno ainda pode ser usado como link de compartilhamento. Substitua o link por um novo link de compartilhamento. O link de compartilhamento interno não funcionará mais a partir do Forms 5.0",
    "Remove Legacy Link" : "Remover Link Legado",
    "Legacy link in use" : "Link legado em uso",
    "This form still uses a deprecated share link, that will be removed in Forms 5.0. Please use the new sharing mechanism." : "Este formulário ainda usa um link de compartilhamento obsoleto, que será removido no Formulários 5.0. Por favor, use o novo mecanismo de compartilhamento."
},
