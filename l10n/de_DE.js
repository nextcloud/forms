OC.L10N.register(
    ...
    "For compatibility with the old Sharing, the internal link is still usable as Share link. Please replace the link with a new Share link. The internal sharing link will not work anymore starting with Forms 5.0" : "Um die Kompatibilität mit der alten Freigabe zu gewährleisten, ist der interne Link weiterhin als Freigabelink verwendbar. Bitte ersetzen Sie den Link durch einen neuen Freigabelink. Der interne Freigabelink wird ab Forms 5.0 nicht mehr funktionieren.",
    "Remove Legacy Link" : "Alten Link entfernen",
    "Legacy link in use" : "Veralteter Link in Verwendung",
    "This form still uses a deprecated share link, that will be removed in Forms 5.0. Please use the new sharing mechanism." : "Dieses Formular verwendet noch einen veralteten Freigabelink, der in Forms 5.0 entfernt werden wird. Bitte verwenden Sie den neuen Freigabemechanismus."
},
