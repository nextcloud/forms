OC.L10N.register(
    ...
    "This form has expired and is no longer taking responses" : "Dieses Formular ist abgelaufen und nimmt keine Antworten mehr entgegen",
    ...
    "Allow form owners to send a confirmation email to respondents after submission." : "Formularbesitzern ermöglichen, den Befragten nach dem Absenden eine Bestätigungs-E-Mail zu senden.",
    "Allow confirmation emails to form respondents" : "Bestätigungs-E-Mails an Antwortende zulassen",
    "Mail server is not configured. Please configure it in the basic settings before enabling this feature." : "Mailserver ist nicht eingerichtet. Bitte in den Grundeinstellungen einrichten, bevor diese Funktion aktiviert wird.",
    "Rate limit (emails per recipient per 24 hours)" : "Ratenbegrenzung (E-Mails pro Empfänger je 24 Stunden)",
    "Maximum number of confirmation emails sent to the same address per 24 hours." : "Maximale Anzahl an Bestätigungs-E-Mails, die je 24 Stunden an dieselbe Adresse gesendet werden.",
    "Form sharing" : "Formular teilen",
    "Allow sharing by link" : "Teilen per Link zulassen",
    "Allow custom public share tokens" : "Benutzerdefinierte öffentliche Freigabetoken erlauben",
    ...
    "Are you sure you want to delete {title}?" : "Möchten Sie {title} löschen?",
    "Cancel" : "Abbrechen",
    ...
    "Add a new row" : "Neue Zeile hinzufügen",
    "Add a new answer option" : "Neue Antwortoption hinzufügen",
    "The text of column {index}" : "Der Text von Spalte {index}",
    "The text of row {index}" : "Der Text von Zeile {index}",
    "The text of option {index}" : "Der Text der Option {index}",
    "Column number {index}" : "Spaltenummer {index}",
    "Row number {index}" : "Zeilenummer {index}",
    ...
    "You must answer this question" : "Sie müssen diese Frage beantworten",
    ...
    "Please wait until the file has been uploaded." : "Bitte warten, bis die Datei hochgeladen wurde.",
    ...
    "_Choose exactly one option_::_Choose exactly %n options_" : ["Genau eine Option auswählen","Genau %n Optionen auswählen"],
    "Choose between {min} and {max} options" : "Zwischen {min} und {max} Optionen auswählen",
    "_Choose at least one option_::_Choose at least %n options_" : ["Mindestens eine Option auswählen","Mindestens %n Optionen auswählen"],
    "_Choose at most one option_::_Choose at most %n options_" : ["Maximal eine Option auswählen","Maximal %n Optionen auswählen"],
    "Upper options limit must not exceed the number of available options" : "Die Obergrenze für Optionen darf die Anzahl der verfügbaren Optionen nicht überschreiten",
    "Upper options limit must be greater than the lower limit" : "Die obere Optionsgrenze muss größer sein als die untere Grenze",
    "Lower options limit must be smaller than the number of available options" : "Die untere Optionsgrenze muss kleiner sein als die Anzahl der verfügbaren Optionen",
    ...
    "Other:" : "Andere:",
    "Other" : "Andere",
    "You must rank all options" : "Es müssen alle Optionen bewertet werden",
    "All options ranked" : "Alle Optionen wurden bewertet",
    "Your ranking" : "Ihre Bewertung",
    "Remove from ranking" : "Aus den Bewertungen entfernen",
    "Tap options above to rank them" : "Auf die obenstehenden Optionen tippen, um sie zu bewerten",
    ...
    "Ranked by Borda count: each 1st place receives {n} points, 2nd place {n1} points, and so on. Higher score means more preferred." : "Rangfolge nach Borda-Anzahl: Jeder 1. Platz erhält {n} Punkte, jeder 2. Platz {n1} Punkte und so weiter. Höhere Punktzahl bedeutet bevorzugter.",
    "avg. rank {average}" : "Durchschnittl. Bewertung {average}",
    ...
    "Hello,\n\nThank you for submitting the form \"{formTitle}\".\n\nBest regards" : "Hallo,\n\nVielen Dank für das Absenden des Formulars \"{formTitle}\".\n\nViele Grüße",
    "Add at least one email field before confirmation emails can be used." : "Vor der Verwendung von Bestätigungs-E-Mails muss mindestens ein E-Mail-Feld hinzugefügt werden.",
    "Select which email field should receive confirmation emails before finishing this setup." : "Vor Abschluss dieser Einstellungen bitte auswählen, welches E-Mail-Feld Bestätigungs-E-Mails erhalten soll.",
    "Untitled question" : "Frage ohne Titel",
    ...
    "Limit number of responses" : "Anzahl der Antworten begrenzen",
    "Maximum number of responses" : "Maximale Anzahl von Antworten",
    "Form will be closed automatically when the limit is reached." : "Das Formular wird automatisch geschlossen, wenn das Limit erreicht ist.",
    "Close form" : "Formular schließen",
    "Closed forms do not accept new responses." : "In geschlossene Formulare können keine neuen Antworten eingegeben werden.",
    "Lock form permanently" : "Formular dauerhaft sperren",
    "Archived forms do not accept new responses and cannot be modified." : "In geschlossene Formulare können keine neuen Antworten eingegeben und nicht geändert werden.",
    ...
    "Send confirmation email to respondents" : "Antwortenden eine Bestätigungs-E-Mail senden",
    ...
    "There was an error while generating the link token" : "Bei der Erstellung des Link-Tokens ist ein Fehler aufgetreten.",
    "There was an error while updating the link token" : "Bei der Aktualisierung des Link-Tokens ist ein Fehler aufgetreten.",
    ...
    "Set the public share link token to something easy to remember or generate a new token." : "Legen Sie für den öffentlichen Freigabelink ein leicht zu merkendes Token fest oder generieren Sie ein neues Token.",
    ...
    "View" : "Ansehen",
    "Edit" : "Bearbeiten",
    "Show responses" : "Antworten anzeigen",
    ...
    "An error occurred while loading responses" : "Beim Laden von Antworten ist ein Fehler aufgetreten.",
    ...
    "An error occurred while deleting this response" : "Beim Löschen der Nachricht ist ein Fehler aufgetreten",
    "An error occurred while deleting responses" : "Beim Löschen von Nachrichten ist ein Fehler aufgetreten",
    ...
    "No responses found" : "Keine Antworten gefunden",
    "No responses found for '{submissionSearch}'" : "Keine Ergebnisse für '{submissionSearch}' gefunden",
    ...
    "There was an error while loading the response" : "Fehler beim Laden der Antwort",
    ...
    "This form has reached the maximum number of responses" : "Dieses Formular hat die maximale Anzahl an Antworten erreicht",
    "This form was closed and is no longer taking responses" : "Dieses Formular wurde geschlossen und es können keine Antworten mehr eingegeben werden",
    ...
    "Grid question title" : "Fragetitel für Raster",
    "People can submit a grid answer" : "Die Teilnehmer können eine Antwort in Form eines Rasters einreichen",
    ...
    "Ranking" : "Rangliste",
    "Ranking question title" : "Titel der Bewertungsfrage",
    "People can rank options" : "Personen können Optionen bewerten",
    "Drag to rank" : "Ziehen, um zu bewerten",
    "Image" : "Bild",
    "Document" : "Dokument",
