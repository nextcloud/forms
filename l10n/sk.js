OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with circle {circle}" : "{user} nazdieľal formulár {formTitle} so skupinou {circle}",
    ...
    "Search for user, group or circle …" : "Hľadať užívateľa, skupinu alebo kruh ...",
