OC.L10N.register(
    ...
    "Delete results" : "Scrios torthaí",
    "Embed" : "Leabaigh",
    "Embed the form in external websites" : "Leabaigh an fhoirm i suíomhanna gréasáin seachtracha",
    ...
    "Allow custom public share tokens" : "Ceadaigh comharthaí comhroinnte poiblí saincheaptha",
    ...
    "_Choose exactly one option_::_Choose exactly %n options_" : ["Roghnaigh rogha amháin go díreach","Roghnaigh %n rogha go díreach","Roghnaigh %n rogha go díreach","Roghnaigh %n rogha go díreach","Roghnaigh %n rogha go díreach"],
    "Choose between {min} and {max} options" : "Roghnaigh idir na roghanna {min} agus {max}",
    "_Choose at least one option_::_Choose at least %n options_" : ["Roghnaigh rogha amháin ar a laghad","Roghnaigh %n rogha ar a laghad","Roghnaigh %n rogha ar a laghad","Roghnaigh %n rogha ar a laghad","Roghnaigh %n rogha ar a laghad"],
    "_Choose at most one option_::_Choose at most %n options_" : ["Roghnaigh rogha amháin ar a mhéad","Roghnaigh %n rogha ar a mhéad","Roghnaigh %n rogha ar a mhéad","Roghnaigh %n rogha ar a mhéad","Roghnaigh %n rogha ar a mhéad"],
    "Upper options limit must not exceed the number of available options" : "Ní fhéadfaidh an teorainn roghanna uachtarach líon na roghanna atá ar fáil a shárú",
    ...
    "Lower options limit must be smaller than the number of available options" : "Ní mór don teorainn roghanna níos ísle a bheith níos lú ná líon na roghanna atá ar fáil",
    ...
    "Other:" : "Eile:",
    "Other" : "Eile",
    "You must rank all options" : "Ní mór duit na roghanna go léir a rangú",
    "All options ranked" : "Gach rogha rangaithe",
    "Your ranking" : "Do rangú",
    "Remove from ranking" : "Bain den rangú",
    "Tap options above to rank them" : "Tapáil na roghanna thuas chun iad a rangú",
    ...
    "Ranked by Borda count: each 1st place receives {n} points, 2nd place {n1} points, and so on. Higher score means more preferred." : "Rangaithe de réir comhaireamh Borda: faigheann gach 1ú háit {n} pointe, gach 2ú háit {n1} pointe, agus mar sin de. Ciallaíonn scór níos airde níos mó rogha.",
    "avg. rank {average}" : "meánrang {average}",
    ...
    "Limit number of responses" : "Teorainn a chur le líon na bhfreagraí",
    "Maximum number of responses" : "Uasmhéid na bhfreagraí",
    "Form will be closed automatically when the limit is reached." : "Dúnfar an fhoirm go huathoibríoch nuair a shroichfear an teorainn.",
    ...
    "There was an error while generating the link token" : "Tharla earráid agus an comhartha nasc á ghiniúint",
    "There was an error while updating the link token" : "Tharla earráid agus an comhartha nasc á nuashonrú",
    "Share link" : "Comhroinn nasc",
    "Add link" : "Cuir nasc leis",
    "Embeddable link" : "Nasc inleabaithe",
    "Embeddable link token" : "Comhartha nasc inleabaithe",
    "Share link token" : "Comhroinn comhartha nasc",
    "Set the public share link token to something easy to remember or generate a new token." : "Socraigh an comhartha nasc comhroinnte poiblí go rud éigin atá éasca le cuimhneamh nó gin comhartha nua.",
    ...
    "Form comments" : "Tráchtanna ar an bhfoirm",
    ...
    "Limit reached" : "Teorainn sroichte",
    "This form has reached the maximum number of responses" : "Tá an líon uasta freagraí sroichte ag an bhfoirm seo",
    ...
    "Ranking" : "Rangú",
    "Ranking question title" : "Teideal na ceiste rangúcháin",
    "People can rank options" : "Is féidir le daoine roghanna a rangú",
    "Drag to rank" : "Tarraing chun rangú a dhéanamh",
    "Image" : "Íomhá",
    "Document" : "Doiciméad",
