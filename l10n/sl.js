OC.L10N.register(
    ...
    "responses" : "odzivi",
    "Share form" : "Souporaba vprašalnika",
    "Share via link" : "Pošlji prek povezave",
    "Show to all users of this instance" : "Pokaži vsem uporabnikom tega oblaka",
    "Choose users to share with" : "Izbor udeležencev za pošiljanje",
    "Settings" : "Nastavitve",
    ...
    "Select expiration date" : "Izbor datuma preteka",
    "Expired on {date}" : "Poteklo na {date}",
    "Expires on {date}" : "Poteče na {date}",
    "Submit" : "Pošlji",
    ...
    "Checkbox question title" : "Naslov izbirnega vprašanja",
    "This question needs a title and at least one answer!" : "To vprašanje zahteva naziv in vsaj en možen odgovor!",
    "Multiple choice" : "Izbirno vprašanje",
    "Multiple choice question title" : "Naslov izbirnega vprašanja",
    "Dropdown" : "Spustni seznam možnosti",
    "Dropdown question title" : "Naslov vprašanja s spustno izbiro",
    "People can pick one option" : "Uporabniki lahko izberejo eno možnost",
    "Pick an option" : "Izbor možnosti",
    "Short answer" : "Kratek odgovor",
    "Short answer question title" : "Naslov vprašanja s kratkim odgovorom",
    "People can enter a short answer" : "Uporabniki lahko vpišejo kratek odgovor",
    "Enter a short answer" : "Vpiši kratek odgovor",
    "Long text" : "Dolg odgovor",
    "Long text question title" : "Naslov vprašanja z dolgim odgovorom",
    "People can enter a long text" : "Uporabniki lahko vpišejo dolg odgovor",
    "Enter a long text" : "Vpiši dolg odgovor",
    "Form expired" : "Vprašalnik je potekel",
    "This form has expired and is no longer taking answers" : "Anketa je potekla, zato odgovorov ni mogoče več pošiljati",
