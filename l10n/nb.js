OC.L10N.register(
    ...
    "Forms" : "Avstemninger",
    "Forms App - New Activity" : "Avstemningsapp - Ny aktivitet",
    "just now" : "akkurat nå",
    "Expired" : "Utløpt",
    ...
    "Delete form" : "Slett avstemning",
    "_There is %n comment_::_There are %n comments_" : ["Det er én %n kommentar","Det er %n kommentarer"],
    "Description" : "Beskrivelse",
    "Create new form" : "Opprett ny avstemning",
    "Update form" : "Oppdater avstemning",
    "Access denied" : "Tilgang nektet",
    "You are not allowed to view this form or the form does not exist." : "Du har ikke tilgang til å se denne avstemningen, eller så finnes den ikke.",
    "You are not allowed to edit this form or the form does not exist." : "Du har ikke tilgang til å redigere denne avstemningen, eller så finnes den ikke.",
    "No description provided." : "Ingen beskrivelse angitt.",
    "The form expired on %s. Voting is disabled, but you can still comment." : "Avstemningen utløp den %s. Du kan ikke lenger avgi stemme, men det går an å kommentere.",
    ...
    "Anononymous form" : "Anonym avstemning",
    "Click to get link" : "Klikk for å hente lenke",
    "Edit Form" : "Rediger avstemning",
    "Form expired" : "Avstemning utløpt",
