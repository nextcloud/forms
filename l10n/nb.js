OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with circle {circle}" : "{user} har delt skjemaet {formTitle} med sirkelen {group}",
    ...
    "Search for user, group or circle …" : "Søk etter bruker, gruppe eller sirkel...",
