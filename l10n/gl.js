OC.L10N.register(
    ...
    "Add a new row" : "Engadir unha nova fila",
    "Add a new answer option" : "Engadir unha nova opción de resposta",
    "The text of column {index}" : "O texto da columna {index}",
    "The text of row {index}" : "O texto da fila {index}",
    ...
    "Grid question title" : "Título da pregunta da grade",
    "People can submit a grid answer" : "A xente pode enviar unha resposta en grella",
