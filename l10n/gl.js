OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with circle {circle}" : "{user} compartiu o formulario {formTitle} co círculo {circle}",
    ...
    "Message to show after a user submitted the form (formatting using Markdown is supported)" : "Mensaxe que se mostrará após que un usuario envíe o formulario (admítese o formatado con Markdown)",
    "Message to show after a user submitted the form. Please note that the message will not be translated!" : "Mensaxe que se mostrará após que un usuario envíe o formulario. Teña en conta que a mensaxe non se traducirá.",
    ...
    "Search for user, group or circle …" : "Buscar por usuario, grupo ou círculo…",
