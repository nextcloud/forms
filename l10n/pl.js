OC.L10N.register(
    ...
    "Only works for logged in users who can access this form" : "Działa tylko dla zalogowanych użytkowników, którzy mają dostęp do tego formularza.",
    "Copy to clipboard" : "Kopiuj do schowka",
    "Public share link" : "Link udostępniania publicznego",
    ...
    "For compatibility with the old Sharing, the internal link is still usable as public link. We recommend replacing the link with a new public link." : "Aby zapewnić zgodność ze starym formatem udostępniania, linku wewnętrznego można wciąż używać jako publicznego. Zalecamy zastąpienie go nowym linkiem publicznym.",
    "Remove Legacy Link" : "Usuń link w starszej wersji",
    "Permit access to all logged in users" : "Zezwól na dostęp wszystkim zalogowanym użytkownikom",
    "Show to all users on sidebar" : "Pokaż na pasku bocznym wszystkim zalogowanym użytkownikom",
