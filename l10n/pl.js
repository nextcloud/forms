OC.L10N.register(
    ...
    "A forms app, similar to Google Forms with the possibility to restrict access (members, certain groups/users, and public)." : "Aplikacja do tworzenia formularzy, na wzór Google Forms, z możliwością ograniczenia dostępu (dla członków, niektórych grup/użytkowników oraz dostępu publicznego).",
    ...
    "Enter a title for this question" : "Wpisz tytuł tego pytania",
    ...
    "Response by {userDisplayName}" : "Odpowiedź {userDisplayName}",
    ...
    "Back to form" : "Powrót do formularza",
    ...
    "There was an error while removing the submission" : "Wystąpił błąd podczas usuwania zgłoszenia",
    "Are you sure you want to delete all submissions from this form?" : "Czy na pewno chcesz usunąć wszystkie zgłoszenia z tego formularza?",
    "There was an error while removing the submissions" : "Wystąpił błąd podczas usuwania zgłoszeń",
    "Settings" : "Ustawienia",
