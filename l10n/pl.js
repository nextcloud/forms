OC.L10N.register(
    ...
    "{user} has shared the form {formTitle} with team {circle}" : "{user}udostępnił(a) formularz {formTitle}z zespołem {circle}",
    "Your form {formTitle} was answered by {user}" : "{user}wypełnił(a) Twój formularz {formTitle}",
    ...
    "Someone <strong>answered</strong> a shared form" : "<strong>Nowa odpowiedź</strong> w udostępnionym formularzu",
    "Someone <strong>answered</strong> a form" : "Ktoś <strong>odpowiedział</strong> na formularz",
    "Nextcloud Forms" : "Formularze Nextcloud",
    ...
    "Forms navigation" : "Nawigacja formularzy",
    ...
    "Form closed" : "Formularz zamknięty",
    ...
    "Unarchive form" : "Przywróć formularz z archiwum",
    "Archive form" : "Archiwizuj formularz",
    ...
    "Add a new answer option" : "Dodaj nową odpowiedź do pytania",
    "Answer number {index}" : "Numer odpowiedzi {index}",
    "Error while saving the answer" : "Błąd podczas zapisywania odpowiedzi",
    "Move option up" : "Przesuń opcję wyżej",
    "Move option down" : "Przesuń opcję niżej",
    ...
    "Move question up" : "Przesuń pytanie do góry",
    "Move question down" : "Przesuń pytanie w dół",
    "Title of question number {index}" : "Tytuł pytania numer {index}",
    "Required" : "Wymagany",
    "Technical name of the question" : "Techniczne oznaczenie pytania",
    "Technical name" : "Techniczna nazwa",
    "Copy question" : "Kopiuj pytanie",
    ...
    "Closed forms do not accept new submissions." : "Zamknięte formularze nie akceptują nowych odpowiedzi.",
    "Archived forms do not accept new submissions and can not be modified." : "Zarchiwizowane formularze nie akceptują nowych odpowiedzi i nie mogą być edytowane. ",
    "Custom submission message" : "Niestandardowy komunikat po wypełnieniu formularza",
    "Message to show after a user submitted the form (formatting using Markdown is supported)" : "Treść niestandardowego komunikatu po wypełnieniu formularza (pole wspiera format Markdown)",
    "Message to show after a user submitted the form. Please note that the message will not be translated!" : "Treść niestandardowego komunikatu po wypełnieniu formularza. Treść nie zostanie przetłumaczona!",
    "Group" : "Grupa",
    "Team" : "Zespół",
    "Permissions" : "Uprawnienia",
    "View responses" : "Pokaż odpowiedzi",
    "Delete responses" : "Usuń odpowiedzi",
    ...
    "Convert to embeddable link" : "Konwertuj na link do umieszczenia",
    ...
    "This form is now owned by" : "Formularz przekazany użytkownikowi",
    ...
    "I understand, transfer this form" : "Rozumiem, przenieś własność formularza",
    ...
    "Responses are connected to your account." : "Odpowiedzi są przypisane do Twojego konta.",
    ...
    "Form is archived" : "Formularz jest zarchiwizowany",
    "Form '{title}' is archived and cannot be modified." : "Formularz {title}jest zarchiwizowany i nie może być edytowany.",
    "Form title" : "Tytuł formularza",
    "Description" : "Opis",
    "Add a question" : "Dodaj pytanie",
    "Summary" : "Podsumowanie",
    "Responses" : "Odpowiedzi",
    "Create spreadsheet" : "Eksportuj wyniki do arkusza",
    ...
    "Choose spreadsheet location" : "Wybierz gdzie zapisać arkusz",
    "Create XLSX" : "Stwórz plik XLSX",
    "Create CSV" : "Stwórz plik CSV",
    "Create ODS" : "Stwórz plik ODS",
    "{amount} responses" : "{amount} odpowiedzi",
    "Open spreadsheet" : "Otwórz arkusz",
    "Save copy to Files" : "Zapisz odpowiedzi do Pliku",
    "Download" : "Pobierz",
    ...
    "This form was closed and is no longer taking answers" : "Formularz został zamknięty i nie akceptuje nowych odpowiedzi",
    ...
    "Uploading …" : "Wysyłanie ...",
    "Search for user, group or team …" : "Wyszukaj użytkownika, grupę lub zespół ...",
