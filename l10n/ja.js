OC.L10N.register(
    ...
    "This form has expired and is no longer taking responses" : "このフォームは期限が切れており、もう回答を取得しません",
    ...
    "Expired {relativeDate}" : " {relativeDate}に期限が切れました",
    "Expires {relativeDate}" : " {relativeDate}に期限が切れます",
    "Delete form" : "フォームを削除",
    ...
    "You must answer this question" : "この質問に回答してください",
    ...
    "Expires on {date}" : "{date} に有効期限が切れます",
    "never" : "なし",
